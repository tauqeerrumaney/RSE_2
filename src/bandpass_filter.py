...
This script loads EEG data from a feather file, applies a bandpass filter to the signals,
and saves the filtered data to a new feather file.
...
Functions:
    bandpass_filter(data, lowcut, highcut, fs, order=5): Applies a bandpass filter to the data.
    apply_filter_to_signal(signal, fs, lowcut=0.1, highcut=60.0, order=5): Wrapper to apply the bandpass filter.
...
def apply_filter_to_signal(signal, fs, lowcut=0.1, highcut=60.0, order=5):
    ...
    Args:
        ...
        fs (float): The sampling frequency of the data.
        lowcut (float, optional): The low cutoff frequency of the filter. Default is 0.1.
        highcut (float, optional): The high cutoff frequency of the filter. Default is 60.0.
        order (int, optional): The order of the filter. Default is 5.
